document.addEventListener("DOMContentLoaded", function () {
    ...
    /* SI SE METE ESTE CÓDIGO ADENTRO DEL setTimeout la palabra final
    no se muestra hasta que no termina el map. 
    Eso sí, se tiene que elminar el que está repetido afuera
